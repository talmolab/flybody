...
def make_default_logger(
  ...
  if wandb_project:
    ...
    wandb = setup_wandb(config=config, project="rodent-imitation", rank_zero_only=False, trial_name=f"{config['run_name']}-{identity}", trial_id=nanoid.generate(), group=config["group_name"]) # with unit uuid
