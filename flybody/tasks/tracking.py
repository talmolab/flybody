...
from dm_control.locomotion.tasks.reference_pose.tracking import DEFAULT_PHYSICS_TIMESTEP, MultiClipMocapTracking
...
class MultiClipMocapTracking(MultiClipMocapTracking):
    ...
    def _set_walker(self, physics: Physics):
        ...
        utils.set_walker_from_features(physics, self._walker, timestep_features, offset=(0,0,0.025))
        if self._props:
